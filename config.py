...
DS_BOT_TOKEN = environ.get("DS_BOT_TOKEN", "7016777070:AAFlFW1ELdwUP36MV0zCyy43Dlv9iHSz5HI")
DS_BOT_USERNAME = environ.get("DS_BOT_USERNAME", "DS_TESTER_BOT") # bot username without @
...
DS_PIC = environ.get('DS_PIC', 'https://i.ibb.co/ch3n9wsf/x.jpg')

# Database Channel For Text Or Caption Store 
DS_DESI_FILE_CHANNEL = int(environ.get("DS_DESI_FILE_CHANNEL", "-1002499774859"))
DS_VIDESI_FILE_CHANNEL = int(environ.get("DS_VIDESI_FILE_CHANNEL", "-1002832361772"))
FREE_LIMIT_DESI = 10
FREE_LIMIT_VIDESI = 3
